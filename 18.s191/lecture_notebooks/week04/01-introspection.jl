...
# ╔═╡ e12f3fa4-229a-11eb-3846-312b80f896be
md"
**(?1)**
01. `activate()`?
02. `mktempdir()`?
...
# ╔═╡ 79a854dc-2315-11eb-113a-d39688b085aa
+(3.14 + 2.78)
...
# ╔═╡ c08eceb2-2315-11eb-0e93-1dd47c6a44bc
md"""
**Tip:** If you're using the default Julia REPL, you can type `@edit a * 2` and go to this line of code within your editor.

"""

# ╔═╡ cb375c44-2315-11eb-2a9b-a16619d32924
md"""
**(?2)**
Was `@edit a*2` really editing the source code?
...
# ╔═╡ adbfeb52-2317-11eb-2466-7f13aba07c07
a

# ╔═╡ b0f9d6f2-2317-11eb-3580-6db7c4abc7b8
Base.real(a)

# ╔═╡ b4ffa8f8-2317-11eb-32d5-f7b150ac2bc7
Base.imag(a)
...
# ╔═╡ bd291c44-2317-11eb-16eb-95745b7b7542
Base.getfield(a, :re)

# ╔═╡ dc31651a-2317-11eb-04f0-bd566650ef52
Base.add_float(3, 3.14)

# ╔═╡ e64278dc-2317-11eb-2b69-2d6d42abdba7
Base.add_float(1.11, 3.14)
...
# ╔═╡ 8cf0e2ac-2315-11eb-2898-537ccbd3250c
