...
#kernel = Kernel.gaussian((0.5, 20))
#kernel = centered([
#		-.5 -1. -.5
#		-1. 7. -1.
#		-.5 -1. -.5
#		])
kernel = Kernel.sobel()[1]
...
# ╔═╡ 269a6e84-02e4-11eb-1d04-0df4e9b5bd0e
begin
	import Pkg
	Pkg.add("Plots")
	Pkg.add("FFTW")
...
begin
	large_image = load("cat_face.jpg")
	#large_image = load("cat_sidewalk.jpg")
...
# ╔═╡ 39ffc900-02d1-11eb-3db6-db54cdad8524
typeof(conv_image)

# ╔═╡ 6af71c96-02d1-11eb-1d5b-2b626f5b9b7a
3 * Gray.(abs.(conv_image))
