...
# ╔═╡ acfecc98-0084-11eb-03a7-976d407d3f3c
RGBX(10, 0, 255)

# ╔═╡ dee73c22-0084-11eb-1b0c-93fc606e02a0
RGBX(reinterpret(N0f8, 128), reinterpret(N0f8, 0), reinterpret(N0f8, 255))
...
# ╔═╡ 72ac7f18-0084-11eb-0524-2dbba05a6575
philip[:]
...
# ╔═╡ 24e1d89e-0086-11eb-1834-bd3f48ab45d2
philip[1000:end, 1:400]
...
# ╔═╡ 4d6fbf92-0086-11eb-1689-cf0aa67429a4
md"`\div` gives the division symbol above"

# ╔═╡ 8c6d48ae-0086-11eb-07d7-a3f5b0cd12f3
20 / 3

# ╔═╡ 92072c9e-0086-11eb-1990-8d9c855783ac
20 // 3

# ╔═╡ 993a5c2a-0086-11eb-3864-a1464ec39780
typeof(20 // 3)
...
# ╔═╡ d6f22876-00a5-11eb-385d-79a2e5bea1f5
new_phil3 = copy(head)

# ╔═╡ 29c99eea-0091-11eb-3fad-8b3f8d08b79b
new_phil3[-200:end, -200:end] = RGB(0, 0, 1)

# ╔═╡ 3edfd718-0091-11eb-0988-7f513577aa46
new_phil3[-200:end, -200:end] .= RGB(0, 0, 1)

# ╔═╡ 53596222-0096-11eb-2e4f-a77457eea35d
new_phil3[end:-50, end:-200] .= RGB(0, 0, 1)

# ╔═╡ 6122dd66-0096-11eb-032e-d91150a79756
new_phil3

# ╔═╡ 63b231ec-0096-11eb-35dd-c7ce7c04dd58


# ╔═╡ 0e8f7910-0096-11eb-3c9c-0f1eb24273f9
new_phil3[1200:end, 2000:end] .= RGB(0, 0, 1);

# ╔═╡ 378be7b0-0096-11eb-029f-e3230d052a76
new_phil3
...
# ╔═╡ 2a4f6eee-00af-11eb-1fe4-f1d7e4c81fee
size(poor_phil)
